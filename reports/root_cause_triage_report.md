...
- Top cause families: `SPC excursion; Low-side excursion; Process instability`
...
| `sensor_min` | 6.787246 | 10.993135 | -11.444759 | critical | Low-side excursion | The lot may contain unusually low sensor readings relative to normal-reference behavior. |
...
- Review possible under-processing, sensor dropout, or low-side transient events.
...
- Top cause families: `SPC excursion; Process center shift; Low-side excursion`
...
| `sensor_min` | 12.419063 | 10.993135 | 3.880133 | critical | Low-side excursion | The lot may contain unusually low sensor readings relative to normal-reference behavior. |
...
- Top cause families: `SPC excursion; Low-side excursion; Process center shift`
...
| `sensor_min` | 7.623870 | 10.993135 | -9.168199 | critical | Low-side excursion | The lot may contain unusually low sensor readings relative to normal-reference behavior. |
...
| `sensor_min` | 7.838808 | 10.993135 | -8.583325 | critical | Low-side excursion | The lot may contain unusually low sensor readings relative to normal-reference behavior. |
...
| `sensor_min` | 8.352029 | 10.993135 | -7.186786 | critical | Low-side excursion | The lot may contain unusually low sensor readings relative to normal-reference behavior. |
...
- Top cause families: `SPC excursion; High-side excursion; Process instability`
...
| `sensor_min` | 10.055782 | 10.993135 | -2.550658 | high | Low-side excursion | The lot may contain unusually low sensor readings relative to normal-reference behavior. |
...
- Top cause families: `SPC excursion; High-side excursion; Process center shift`
...
| `sensor_max` | 17.845876 | 15.081540 | 6.375667 | critical | High-side excursion | The lot may contain unusually high sensor readings relative to normal-reference behavior. |
...
- Top cause families: `SPC excursion; Process instability; High-side excursion`
...
| `sensor_max` | 17.233025 | 15.081540 | 4.962186 | critical | High-side excursion | The lot may contain unusually high sensor readings relative to normal-reference behavior. |
